...
public class SpUtils {
    ...
    public static void save(Context context, String key, Object obj){
        SharedPreferences sp = context.getSharedPreferences("config_english", Context.MODE_PRIVATE);
    ...
    public static SharedPreferences get(Context context){
        ...
        return context.getSharedPreferences("config_english", Context.MODE_PRIVATE);
    }
